  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-white data-[state=open]:animate-in duration-300  data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom-translate-full data-[state=open]:slide-in-from-bottom-translate-full md:data-[state=closed]:fade-out-0 md:data-[state=open]:fade-in-0 md:data-[state=closed]:zoom-out-95 md:data-[state=open]:zoom-in-95 fixed bottom-0 md:top-[50%] left-[50%] z-50 grid w-screen h-fit md:max-w-[calc(100%-30rem)] translate-x-[-50%] md:translate-y-[-50%] gap-4 md:rounded-lg border border-slate-200 p-6 shadow-lg md:duration-200 sm:max-w-lg dark:bg-slate-950 dark:border-slate-800",
          className
        )}
        {...props}
      >
