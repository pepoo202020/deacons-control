...
export default function MenuNav() {
  ...
  return (
    <div
      className='w-full px-10 flex items-center justify-center bg-neutral-300 dark:bg-blue-950 text-blue-950 dark:text-white overflow-y-auto'
    >
      {
