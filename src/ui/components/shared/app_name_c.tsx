...
export default function AppNameComponent( { isSplashScreen, size, className }: AppNameComponentProps ) {
    ...
    return (
        <div className={cn(
            "text-2xl font-bold flex flex-col gap-1 items-center justify-center",
            isSplashScreen ? "text-4xl items-start" : size === "small" ? "text-xl" : size === "medium" ? "text-2xl" : "text-3xl",
            className
        )}>
